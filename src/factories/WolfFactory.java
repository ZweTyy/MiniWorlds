 ...
 * It provides a static method to create a wolf pack with a specified number of
 * wolves.
 */
public class WolfFactory {

    /**
     * Creates a WolfPack in the given world, populating it with a specified number
     * of wolves.
     ...
     * @param size           The size parameter for the creation of wolves and the
     *                       wolf pack.
     * @param numberOfWolves The number of wolves to create and add to the wolf
     *                       pack.
     * @return A newly created WolfPack populated with the specified number of
     *         wolves.
     */
    public static WolfPack createWolfPack(World world, int size, int numberOfWolves) {
        WolfPack wolfPack = new WolfPack(world, size);
        wolfPack.createDen(world, size);
